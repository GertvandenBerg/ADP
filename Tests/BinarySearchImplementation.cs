...
namespace Tests
{
    public class BinarySearchImplementationTests
    {
        ...
        public void BinarySearch_FindsElementInArray()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, 5, (a, b) => a.CompareTo(b));
        ...
        public void BinarySearch_ReturnsNegativeOne_WhenElementNotFound()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, 4, (a, b) => a.CompareTo(b));
        ...
        public void BinarySearch_FindsFirstElement()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, 1, (a, b) => a.CompareTo(b));
        ...
        public void BinarySearch_FindsLastElement()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, 9, (a, b) => a.CompareTo(b));
        ...
        public void BinarySearch_ReturnsNegativeOne_WhenSingleElementNotFound()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, 3, (a, b) => a.CompareTo(b));
        ...
        public void BinarySearch_WorksForStrings()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, "cherry", (a, b) => string.Compare(a, b));
        ...
        public void BinarySearch_ReturnsNegativeOne_WhenStringNotFound()
        {
            ...
            int result = searcher.BinarySearch(sortedArray, "grape", (a, b) => string.Compare(a, b));
        ...
        {
            var searcher = new BinarySearchImplementation();
            int[] largeArray = Enumerable.Range(0, 1_000_001).ToArray();
            int target = 987_654;
            int steps = 0;

            int result = searcher.BinarySearch(largeArray, target, (a, b) =>
            {
                steps++;
